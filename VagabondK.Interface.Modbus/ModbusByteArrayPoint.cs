...
{
    public class ModbusByteArrayPoint : ModbusVariableLengthPoint<byte[]>
    {
        /// <summary>
        /// 생성자
        /// </summary>
        ...
        public ModbusByteArrayPoint(byte slaveAddress = 0, bool writable = true, ushort address = 0, int bytesLength = 2, bool skipFirstByte = false, ModbusEndian endian = ModbusEndian.AllBig, ushort? requestAddress = null, ushort? requestLength = null, bool? useMultiWriteFunction = null, IEnumerable<InterfaceHandler> handlers = null)
