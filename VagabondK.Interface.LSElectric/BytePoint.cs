...
namespace VagabondK.Interface.LSElectric
{
    ...
    /// byte 형식 인터페이스 포인트
    /// </summary>
    public class BytePoint : PlcPoint<byte>
    {
        /// <summary>
        /// 생성자
        /// </summary>
        ...
        public BytePoint(DeviceVariable deviceVariable, IEnumerable<InterfaceHandler> handlers = null)
        ...
        protected override DeviceValue ToDeviceValue(byte value) => new DeviceValue(value);
        ...
        protected override byte ToPointValue(DeviceValue deviceValue) => deviceValue;
    }
}