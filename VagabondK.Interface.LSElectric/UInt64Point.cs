...
namespace VagabondK.Interface.LSElectric
{
    ...
    /// ulong 형식 인터페이스 포인트
    /// </summary>
    public class UInt64Point : PlcPoint<ulong>
    {
        /// <summary>
        /// 생성자
        /// </summary>
        ...
        public UInt64Point(DeviceVariable deviceVariable, IEnumerable<InterfaceHandler> handlers = null)
        ...
        protected override DeviceValue ToDeviceValue(ulong value) => new DeviceValue(value);
        ...
        protected override ulong ToPointValue(DeviceValue deviceValue) => deviceValue;
    }
}