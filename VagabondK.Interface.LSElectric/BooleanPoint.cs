...
namespace VagabondK.Interface.LSElectric
{
    ...
    /// bool 형식 인터페이스 포인트
    /// </summary>
    public class BooleanPoint : PlcPoint<bool>
    {
        /// <summary>
        /// 생성자
        /// </summary>
        ...
        public BooleanPoint(DeviceVariable deviceVariable, IEnumerable<InterfaceHandler> handlers = null)
        ...
        protected override DeviceValue ToDeviceValue(bool value) => new DeviceValue(value);
        ...
        protected override bool ToPointValue(DeviceValue deviceValue) => deviceValue;
    }
}