...
namespace VagabondK.Interface.LSElectric
{
    ...
    /// uint 형식 인터페이스 포인트
    /// </summary>
    public class UInt32Point : PlcPoint<uint>
    {
        /// <summary>
        /// 생성자
        /// </summary>
        ...
        public UInt32Point(DeviceVariable deviceVariable, IEnumerable<InterfaceHandler> handlers = null)
        ...
        protected override DeviceValue ToDeviceValue(uint value) => new DeviceValue(value);
        ...
        protected override uint ToPointValue(DeviceValue deviceValue) => deviceValue;
    }
}