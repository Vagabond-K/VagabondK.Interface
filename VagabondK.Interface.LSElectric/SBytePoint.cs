...
namespace VagabondK.Interface.LSElectric
{
    ...
    /// sbyte 형식 인터페이스 포인트
    /// </summary>
    public class SBytePoint : PlcPoint<sbyte>
    {
        /// <summary>
        /// 생성자
        /// </summary>
        ...
        public SBytePoint(DeviceVariable deviceVariable, IEnumerable<InterfaceHandler> handlers = null)
        ...
        protected override DeviceValue ToDeviceValue(sbyte value) => new DeviceValue(value);
        ...
        protected override sbyte ToPointValue(DeviceValue deviceValue) => deviceValue;
    }
}