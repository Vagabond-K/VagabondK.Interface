...
namespace VagabondK.Interface.LSElectric
{
    ...
    /// long 형식 인터페이스 포인트
    /// </summary>
    public class Int64Point : PlcPoint<long>
    {
        /// <summary>
        /// 생성자
        /// </summary>
        ...
        public Int64Point(DeviceVariable deviceVariable, IEnumerable<InterfaceHandler> handlers = null)
        ...
        protected override DeviceValue ToDeviceValue(long value) => new DeviceValue(value);
        ...
        protected override long ToPointValue(DeviceValue deviceValue) => deviceValue;
    }
}