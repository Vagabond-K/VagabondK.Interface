...
namespace VagabondK.Interface.LSElectric
{
    ...
    /// ushort 형식 인터페이스 포인트
    /// </summary>
    public class UInt16Point : PlcPoint<ushort>
    {
        /// <summary>
        /// 생성자
        /// </summary>
        ...
        public UInt16Point(DeviceVariable deviceVariable, IEnumerable<InterfaceHandler> handlers = null)
        ...
        protected override DeviceValue ToDeviceValue(ushort value) => new DeviceValue(value);
        ...
        protected override ushort ToPointValue(DeviceValue deviceValue) => deviceValue;
    }
}