...
namespace VagabondK.Interface.LSElectric
{
    ...
    /// float 형식 인터페이스 포인트
    /// </summary>
    public class SinglePoint : PlcPoint<float>
    {
        /// <summary>
        /// 생성자
        /// </summary>
        ...
        public SinglePoint(DeviceVariable deviceVariable, IEnumerable<InterfaceHandler> handlers = null)
        ...
        protected override DeviceValue ToDeviceValue(float value) => new DeviceValue(value);
        ...
        protected override float ToPointValue(DeviceValue deviceValue) => deviceValue;
    }
}