...
namespace VagabondK.Interface.LSElectric
{
    ...
    public class PlcPointAttribute : InterfacePointAttribute
    {
        ...
        protected override InterfacePoint OnCreatePoint(MemberInfo memberInfo, InterfaceAttribute rootAttribute)
        {
            ...
            {
                case nameof(Boolean):
                    return new BooleanPoint(DeviceVariable);
                case nameof(SByte):
                    return new SBytePoint(DeviceVariable);
                case nameof(Byte):
                    return new BytePoint(DeviceVariable);
                case nameof(Int16):
                    return new Int16Point(DeviceVariable);
                case nameof(UInt16):
                    return new UInt16Point(DeviceVariable);
                case nameof(Int32):
                    return new Int32Point(DeviceVariable);
                case nameof(UInt32):
                    return new UInt32Point(DeviceVariable);
                case nameof(Int64):
                    return new Int64Point(DeviceVariable);
                case nameof(UInt64):
                    return new UInt64Point(DeviceVariable);
                case nameof(Single):
                    return new SinglePoint(DeviceVariable);
                case nameof(Double):
                    return new DoublePoint(DeviceVariable);
                default:
                    return null;
            };
